								...
								@if(count(Helper::getAllProductFromCart()) > 0)
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="price" data-title="Price"><span>{{number_format($cart['price'],2)}}</span> <u>đ</u> </td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money">{{$cart['amount']}}<u>đ</u></span></td>
								...
								@else
										<tr>
											<td class="text-center" colspan="6">
												Không có sản phẩm nào trong giỏ hàng. <a href="{{route('product-grids')}}" style="color:blue;">Tiếp tục mua hàng</a>
											</td>
										</tr>
								@endif
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Bạn đã tiết kiệm<span>{{number_format(Session::get('coupon')['value'],2)}} <u>đ</u></span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Bạn cần thanh toán<span>{{number_format($total_amount,2)}}<u>đ</u></span></li>
										@else
											<li class="last" id="order_total_price">Bạn cần thanh toán<span>{{number_format($total_amount,2)}}<u>đ</u></span></li>
										@endif
									</ul>
