...
@section('main-content')
    ...
    <form action="{{route('shop.filter')}}" method="POST">
        @csrf
        <section class="product-area shop-sidebar shop section-body">
            <div class="container">
                <div class="row">
                                            ...
                                            <div class="content">
                                                ...
                                                @if($product->discount != 0)
                                                    <p class="price">
                                                        ...
                                                        <span>{{number_format($org,2)}}</span> <u>đ</u>
                                                    </p>
                                                @else
                                                    <p class="price">
                                                        <span>
                                    ...
                                    <div class="shop-shorter">
                                        ...
                                        <div class="single-shorter">
                                            ...
                                            <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                                ...
                                                <option value="prive" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='price') selected @endif>Price</option>
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <div class="quickview-content">
                                            ...
                                            @if($product->discount != 0)
                                                <h3>
                                                    <small><del class="text-muted">{{number_format($product->price,2)}}</del> <u>đ</u> </small>
