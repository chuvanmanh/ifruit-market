												...
												<ul class="slides">
													...
													@foreach($photo as $data)
														<li data-thumb="{{$data}}" rel="adjustX:10, adjustY:">
															<img src="{{asset(str_replace('http://localhost', '', $data))}}" alt="{{$data}}">
														</li>
													@endforeach
												</ul>
											</div>
										...
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @if($product_detail->discount != 0)
                                                    <p class="price">
                                                        <span class="discount">
                                                            {{number_format($after_discount,2)}} <u>đ</u>
                                                        </span>
                                                        <s>{{number_format($product_detail->price,2)}}</s> <u>đ</u>
                                                    </p>
                                                @else
                                                    <p class="price">
                                                        <span>
                                                            {{number_format($product_detail->price,2)}} <u>đ</u>
                                                        </span>
                                                    </p>
                                                @endif
											...
											<div class="product-buy">
												...
												@endif
{{--												<p class="availability">Trong kho : @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span>  @endif</p>--}}
											</div>
											<!--/ End Product Buy -->
										</div>
									</div>
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	<div class="add-review">
																		<h5>Thêm đánh giá</h5>
																		<p>Email của bạn sẽ được bảo mật. Các trường bắt buộc đã được dánh dấu *</p>
																	</div>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Thêm vào Wishlist</span></a>
                                            </div>
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            @if($data->discount != 0)
                                                <span class="old">{{number_format($data->price,2)}} <u>đ</u></span>
                                                <span>{{number_format($after_discount,2)}} <u>đ</u></span>
                                            @else
                                                <span>{{number_format($data->price,2)}} <u>đ</u></span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
