...
<style type="text/css">
  ...
  <div class="invoice-header">
    ...
    <div class="float-right site-address">
      <h4>Ifruits Market</h4>
      <p>10/106 Hoàng Quốc Việt, Nghĩa Đô, Cầu Giấy</p>
      <p>Phone: <a href="tel:0966.616.356">0966.616.356</a></p>
      <p>Email: <a href="mailto:ifruitsmarket@gmail.com">ifruitsmarket@gmail.com</a></p>
    </div>
    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>{{number_format($cart->price,2)}}<u>đ</u><u>đ</u></span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>{{number_format($order->sub_total,2)}}<u>đ</u></span></th>
        </tr>
      ...
      @endif --}}
        <tr>
          ...
          @php
            ...
            $shipping_charge = (float)$order->total_amount + (float)$order->coupon - (float)$order->sub_total;
            @endphp
          <th scope="col" class="text-right ">Shipping:</th>
          <th><span>{{number_format($shipping_charge,2)}}<u>đ</u></span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
          ...
          <th>
            <span>
                {{number_format($order->total_amount,2)}}<u>đ</u>
            </span>
          </th>
        </tr>
      </tfoot>
