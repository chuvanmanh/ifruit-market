...
{{--        </div>--}}
        ...
        <div class="form-group">
          ...
          <input id="thumbnail" class="form-control" type="text" name="photo" value="{{asset(str_replace('http://localhost', '', $product->photo))}}">
        </div>
        <div id="holder" style="margin-top:15px;max-height:200px;">
            @if(!empty($product->photo))
                <img style="margin-top:10px;max-height:200px;" src="{{asset(str_replace('http://localhost', '', $product->photo))}}">
            @endif
        </div>
          @error('photo')
          <span class="text-danger">{{$message}}</span>
