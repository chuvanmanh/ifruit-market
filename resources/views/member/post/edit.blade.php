    ...
    <div class="card-body">
      <form method="post" action="{{route('post.update',$post->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="thumbnail" class="form-control" type="text" name="photo" value="{{asset(str_replace('http://localhost', '', $post->photo))}}">
        </div>
        <div id="holder" style="margin-top:10px;max-height:200px;">
            @if(!empty($post->photo))
                <img style="margin-top:10px;max-height:200px;" src="{{asset(str_replace('http://localhost', '', $post->photo))}}">
            @endif
        </div>
